export function VacancyDetailsPanel({
  vacancyData,
  handleApplyToVacancy,
  role,
}) {
  return (
    <div className="px-6 py-8 w-full xl:max-w-[505px] border border-black rounded-2xl">
      <div className="flex flex-col">
        <div className="border-b border-black/30">
          <div className="flex flex-col gap-1 pb-5">
            <div className="flex flex-row  justify-between items-center">
              <p className="text-black t-subhead">Salary:</p>
              <p className="text-black t-heading">
                {vacancyData.salary}$/month
              </p>
            </div>
            <div className="flex flex-row justify-between">
              <p className="text-black t-subhead">Work experience:</p>
              <p className="text-black t-heading">
        ...
        <div className="border-b border-black/30 py-5">
          <div className="flex flex-col gap-4">
            <div className="flex flex-row justify-between items-center">
              <p className="text-black t-body ">Location:</p>
        ...
        <div className="flex flex-row  gap-7 pt-5">
          ...
          {role === "ROLE_USER" ? (
            <button
              className="w-full bg-green py-3 rounded-2xl button-konkhmer cursor-pointer"
              onClick={() => handleApplyToVacancy(vacancyData.id)}
            >
              Apply for this job
            </button>
          ) : role === null ? (
            <a
              href="/user-login"
              className="w-full py-3 bg-green font-konkhmer rounded-2xl text-center"
            >
              Sign In to apply
            </a>
          ) : null}
