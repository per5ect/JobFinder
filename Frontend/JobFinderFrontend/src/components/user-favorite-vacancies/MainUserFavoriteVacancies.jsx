...
import { getUserFavoriteVacancies } from "../../services/userService.js";
    ...
    <main>
      <Layout>
        <div className="mt-13 flex flex-col items-start w-full">
          <h1 className="w-fit bg-black text-white t-display px-7">
            My favorite vacancies
          </h1>
          <div className="w-full mt-13 mb-13">
            {favorites.length === 0 ? (
              <div className="flex flex-col items-start gap-4">
                <h1 className="text-center t-heading text-black">
                  You don't have a favorite vacancy yet:(((
                </h1>
                <a
                  href="/all-vacancies"
                  className="font-konkhmer bg-green text-black px-5 py-2 rounded-xl transition-colors ease-in-out hover:bg-green/90"
                >
                  Job Search
                </a>
              </div>
