    ...
    <>
      <div className="xl:hidden flex flex-col mt-10 gap-8">
        <div className="bg-black w-fit px-6 py-4">
          <p className="font-kosugi text-2xl sm:text-3xl md:text-4xl text-white">
            How it works???
          </p>
        </div>
        ...
        <a
          href="/analyze"
          className="py-4 sm:py-5 md:py-6 px-8 bg-green text-xl sm:text-2xl md:text-3xl text-center text-black font-kosugi transition-colors ease-in-out hover:bg-green/90"
        >
          Start right now
        </a>
      </div>
      ...
      <div className="hidden xl:flex flex-col mt-20 gap-15">
        <div className="bg-black h-25 flex justify-center items-center w-90">
          <p className="font-kosugi text-[36px] text-white py-7.5">
            How it works???
          </p>
        </div>
        ...
        <a
          href="/analyze"
          className="py-[30px] px-[93px] bg-green text-[36px] text-center text-black font-kosugi ml-auto transition-colors ease-in-out hover:bg-green/90"
        >
          Start right now
        </a>
      </div>
