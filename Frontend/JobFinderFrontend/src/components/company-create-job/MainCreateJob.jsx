...
export function MainCreateJob() {
  ...
  return (
    <main>
      <Layout>
        <div className="mt-13">
          <h1 className="text-black t-display">Create New Job</h1>
          <div className="flex flex-col container mx-auto max-w-[553px] mb-15 mt-13">
            <form onSubmit={handleSubmit} className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-2 border-b border-black/30 pb-9">
                <label htmlFor="jobName" className="t-body text-black">
                  Job name
                </label>
                <input
                  type="text"
              ...
              {/* Description */}
              <div className="flex flex-col gap-2 border-b border-black/30 pb-9">
                <label htmlFor="jobdescription" className="t-body text-black">
                  Job description (max 300 characters)
                </label>
                <p className="text-left t-label text-gray-500">
              ...
              {/* Salary */}
              <div className="flex flex-col gap-2 border-b border-black/30 pb-9">
                <label htmlFor="jobSalary" className="t-body text-black">
                  Salary (in $)
                </label>
                <input
                  type="text"
              ...
              {/* Location */}
              <div className="flex flex-col gap-2 border-b border-black/30 pb-9">
                <label htmlFor="jobCity" className="t-body text-black">
                  Job Location (City)
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-row gap-6 ">
                <div className="flex flex-col gap-2 w-full">
                  <label htmlFor="knowlvl" className="t-body text-black">
              ...
              <div className="flex flex-row gap-6 border-b border-black/30 pb-9">
                <div className="flex flex-col gap-2 w-full">
                  <label htmlFor="tofEmploy" className="t-body text-black">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...prev,
                        typeOfEmployment: e.target.value,
                      }))
                    }
                  >
                    <option value="" disabled hidden>
                ...
                <div className="flex flex-col gap-2 w-full">
                  <label htmlFor="workExp" className="t-body text-black">
              ...
              <SearchTechnologyCompany
                onChange={(ids) =>
                  setFormData((prev) => ({ ...prev, technologyIds: ids }))
                }
              />
              <JobOfferingsInput
                onChange={(list) =>
                  setFormData((prev) => ({ ...prev, offerings: list }))
                }
              />
              ...
              <button
                type="submit"
                className="mt-10 w-full bg-blue text-white button-kosugi rounded-[10px] py-3.5 cursor-pointer transition-colors ease-in-out hover:bg-blue/90"
              >
                Create job
              </button>
            </form>
