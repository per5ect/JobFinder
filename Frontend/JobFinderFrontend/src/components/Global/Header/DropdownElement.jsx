  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        className="bg-green flex justify-center items-center lg:w-25 lg:h-25 transition-colors ease-in-out hover:bg-green/90"
      >
        <img src="/icons/Menu.svg" alt="" className="text-black" />
      </button>

      {isOpen && (
        <div className="absolute left-0 z-10 bg-green w-48">
          <ul className="text-sm text-black font-kosugi">
            {dropdownByRole(userRole)}
            <li>
              <div
                className="flex flex-row items-center w-full bg-red text-white px-4 py-3 gap-2
