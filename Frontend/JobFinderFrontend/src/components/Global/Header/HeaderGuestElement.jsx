    ...
    <div>
      <div className="flex justify-between items-center h-16 sm:h-20 lg:h-25">
        <div className="flex items-center gap-4 lg:gap-[68px]">
          ...
          <a
            href="/for-companies"
            className="hidden lg:block px-4 xl:px-6 py-1.5 text-black bg-white underline underline-offset-3 font-kosugi rounded-xl
        ...
        <a
          href="/all-vacancies"
          className="hidden lg:block px-4 xl:px-6 py-1.5 text-black bg-green underline underline-offset-3 font-kosugi rounded-xl
        ...
        <div className="hidden lg:flex items-center gap-3 xl:gap-5">
          <a
            href="/user-login"
            className="px-4 xl:px-6 py-1.5 text-white bg-blue rounded-xl font-kosugi transition-colors ease-in-out hover:bg-blue/90 whitespace-nowrap"
          >
            Sign in / Sign up
          </a>
        ...
        <div className="flex lg:hidden items-center gap-2">
          <a
            href="/user-login"
            className="px-3 sm:px-4 py-1.5 text-white bg-blue rounded-xl font-kosugi text-sm sm:text-base transition-colors ease-in-out hover:bg-blue/90 whitespace-nowrap"
          >
            Sign in
          </a>
          <button
      ...
      {mobileOpen && (
        <div className="lg:hidden flex flex-col border-t border-white/10">
          <a
            href="/for-companies"
            className="px-4 py-3 sm:py-4 text-black bg-white font-kosugi sm:text-lg transition-colors hover:bg-white/90"
          >
            For the employers
          </a>
          <a
          ...
          <a
            href="/my-account"
            className="px-4 py-3 sm:py-4 text-white bg-blue font-kosugi sm:text-lg transition-colors hover:bg-blue/90"
          >
            My account
          </a>
        </div>
