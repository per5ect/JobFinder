...
export function UploadElement({ setAnalyseStep,analyseResult }) {
    ...
    return (
        <div className="text-center w-full max-w-[750px]">
            <h2 className="t-heading bg-green py-9 rounded-t-xl">{isUploaded ? "Analyze your resume" : "Upload your resume (PDF or DOCX)" }</h2>
                <div className="w-full flex flex-col gap-10 px-8 py-5 border border-black/20 border-t-0 rounded-b-xl min-h-[400px]">
                    <div className="w-full flex flex-col items-start mt-4">
                        ...
                        <p className="t-body text-black ">{isUploaded ? "🤖 Artificial intelligence analyzes your experience,skills and education" : " 🤖 Select your resume in a pdf format"}  </p>
                    </div>
                    <div
                        {...getRootProps()}
