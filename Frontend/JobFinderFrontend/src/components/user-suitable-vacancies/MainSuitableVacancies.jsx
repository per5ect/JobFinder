        ...
        {userCV === "" || userResumeTechnologies == null ? (
          <div className="w-full flex justify-center">
            <div className="w-full xl:max-w-[800px] flex flex-col items-center justify-center mt-20 rounded-xl border border-black py-10 px-6 xl:py-15 xl:px-15 gap-10">
              <h1 className="t-heading text-black text-center">
                To get the suitable vacancies, upload and analyze your resume
                first
              </h1>
              <a
                href="/analyze"
          ...
          <>
            <section className="flex flex-col items-start gap-12 border-b pb-10">
              <div className="flex flex-col xl:flex-row w-full xl:justify-between xl:items-start gap-5">
                <div className="flex flex-col items-start gap-5">
                  <h1 className="t-display bg-black text-white py-2 px-5">
                    Suitable vacancies
                  </h1>
                  <p className="t-body">
                    After analyzing your resume, we can suggest jobs that fit
                    your experience and technology set
                  </p>
                </div>

                <a
                  href="/cv-details"
                  className="t-subhead text-black bg-green px-10 py-2 rounded-xl w-fit whitespace-nowrap self-start"
                >
                  Resume Details
                </a>
              </div>
            ...
            {isLoading && vacancies.length === 0 ? (
              ...
              <div className="flex flex-col items-center w-full">
                {vacancies.length === 0 ? (
                  <p className="t-heading text-center text-black pt-10 pb-20">
                    No vacancies found 😔
                  </p>
                ) : (
                ...
                {hasMore && (
                  <button
                    ...
                    className="mt-8 px-6 py-2 bg-green text-black button-kosugi rounded-xl cursor-pointer"
                  >
                    Load more
                  </button>
                )}
