  ...
  return (
    <div>
      <div className="flex justify-between items-center h-16 sm:h-20 lg:h-25">
        <div className="bg-white flex items-center gap-3 h-16 sm:h-20 lg:h-25 px-4 lg:px-7 flex-shrink-0">
          <a href="/main-admin-page">
            <img src="/Logo.svg" alt="" />
          </a>
          <p className="font-kosugi text-black text-sm lg:text-[20px] whitespace-nowrap">
            Admin Page
          </p>
        </div>
