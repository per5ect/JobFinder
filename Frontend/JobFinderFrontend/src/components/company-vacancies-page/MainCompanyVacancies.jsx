      ...
      <Layout>
        <div className="flex flex-col items-start w-full">
          <div className="w-full flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex flex-row items-center py-3 px-6.5 gap-1 bg-green rounded-2xl transition-colors ease-in-out hover:bg-green/80 w-fit">
          ...
          <div className="mt-8 xl:mt-15 flex flex-col gap-6 xl:gap-15 w-full">
