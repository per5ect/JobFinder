        ...
        <div>
          <div className="flex justify-between items-center h-16 sm:h-20 lg:h-25">
            <div className="flex items-center gap-4 lg:gap-[68px]">
              ...
              <a
                href="/"
                className="hidden lg:block px-4 xl:px-6 py-2 text-black bg-white underline underline-offset-3 font-kosugi rounded-xl
            ...
            <div className="hidden lg:flex items-center gap-3 xl:gap-5">
              <a
                href="/company-login"
                className="px-4 xl:px-6 py-2 text-white bg-blue font-kosugi rounded-xl transition-colors ease-in-out hover:bg-blue/90 whitespace-nowrap"
              >
                Sign in / Sign up
              </a>
