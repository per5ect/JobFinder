...
export function MainUserRegister() {
          ...
          <div className="flex flex-col items-center w-full max-w-[505px] mx-auto py-12 px-6 mt-7.5 mb-7.5 border border-[#222A24]/40">
            <div className="w-full">
              <div className="flex flex-col mb-4">
                <h2 className="text-black t-heading leading-8">Sign up to</h2>
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-5">
                  <div className="flex flex-col gap-4 flex-1">
                    <label htmlFor="firstName" className="t-label text-black">
                      Name
                    </label>
                    <input
                      type="text"
                      ...
                      onChange={handleChange}
                      className="py-4 p-6.5 border border-[#222A24] rounded-md input-kosugi w-full"
                    />
                  </div>

                  <div className="flex flex-col gap-4 flex-1">
                    <label htmlFor="lastName" className="t-label text-black">
                      Surname
                    </label>
                    <input
                      type="text"
            ...
            <div className="mt-7">
              ...
              <a href="/user-login" className="text-blue font-konkhmer pl-1">
                Sign In
              </a>
            </div>
          </div>
