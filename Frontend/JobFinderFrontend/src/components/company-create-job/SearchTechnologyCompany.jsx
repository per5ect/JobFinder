  ...
  return (
    <div className="space-y-8 border-b border-black/30 pb-9">
      ...
      <div className="mt-10 pt-2">
        <p className="t-body text-black">Selected technologies:</p>
        <div className="flex flex-wrap gap-2 mt-4">
          {selectedTechnologies.map((tech) => (
            <div
              key={tech.id}
              className="cursor-pointer bg-blue font-konkhmer text-white border rounded-2xl px-7.5 py-2 flex items-center gap-2"
            >
